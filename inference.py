...
if __name__ == '__main__':
    ...
    name_folder='C:/Users/iialab/Desktop/o2o/paper_ftmatch/name_data_img_individual/'  # 이름만 모아 놓은 곳
    ...
    for image_file, label_file in zip(image_files, label_files):
        ...
        for snack in snack_dict.keys():
            ...
            predictName = compare_ftdetect(modify_img, f"{name_folder}/{j+1}/")        
            predictNum = classes_dict.get(predictName, -1)
            correct_number=int(snack_dict[snack][2])
            found_key=None
            for key, value in classes_dict.items():
                if value== correct_number:
                    ...
                    break
            #print(found_key)
            print(predictNum, predictName, correct_number, found_key)
