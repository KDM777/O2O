...
if __name__ == '__main__':
    model = YOLO('C:/Users/iialab/runs/detect/train16/weights/best.pt')  # 저장된 모델인 'best.pt' 로드

    image_folders='C:/Users/iialab/Desktop/o2o/v1/second/train/images/' # 이름을 가져오는 폴더
    name_folder='C:/Users/iialab/Desktop/o2o/v1/name/' # 이름을 저장하는 폴더
